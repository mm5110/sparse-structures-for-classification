...
def save_SL_CSC_IHT(CSC, stride, dp_channels, atom_r, atom_c, numb_atom, filename):
    ...
    other_CSC_variable_data["forward_type"] = CSC.forward_type
...
def load_SL_CSC_IHT(filename):
    ...
    if loaded_CSC_vars["forward_type"] == "IHT":
        ...
        CSC = IHT.SL_CSC_IHT_Joint(loaded_CSC_vars["stride"], loaded_CSC_vars["dp_channels"], loaded_CSC_vars["atom_r"], loaded_CSC_vars["atom_c"], loaded_CSC_vars["numb_atom"], loaded_CSC_vars["k"], loaded_CSC_vars["alpha"])
